...
return { ok: true, mensaje: `Hola, ¡BIENVENIDO AL SISTEMA BANCARIO DE CAMILA CAMACHO!"${nombre}, retiro aprobado`, saldo: saldoInicial -
monto };
} else {
return { ok: false, mensaje: `Hola,¡BIENVENIDO AL SISTEMA BANCARIO DE CAMILA CAMACHO! ${nombre}, no tienes suficiente saldo`, saldo:
saldoInicial };
